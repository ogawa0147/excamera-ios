...
final class PlayerViewController: UIViewController, FactoryMethodInjectable {
    ...
    lazy var dismissButton: UIButton = {
        ...
        button.setImage(Asset.Assets.iconCancel.image.withRenderingMode(.alwaysTemplate), for: .normal)
    ...
    lazy var shareButton: UIButton = {
        ...
        button.imageEdgeInsets = UIEdgeInsets(top: 4, left: 4, bottom: 4, right: 4)
        button.setImage(Asset.Assets.iconShare.image.withRenderingMode(.alwaysTemplate), for: .normal)
