...
final class CameraEffectViewController: UIViewController, FactoryMethodInjectable {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        view.register(CameraEffectCell.self, forCellWithReuseIdentifier: "CameraEffectCell")
        return view
    }()
...
extension CameraEffectViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let element = dataSource.items[indexPath.row]
        element.blurEffectView.frame = captureView.frame
        element.vibrancyView.frame = captureView.frame
        captureView.addSubview(element.blurEffectView)
...
extension CameraEffectViewController: UICollectionViewDelegateFlowLayout {
